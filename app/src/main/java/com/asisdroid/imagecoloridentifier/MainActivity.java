...
// Set your new, scaled drawable "d"
    ...
    public void initColorNameHashMap(){
        ...
        colorNameDB.insertNewColorData("566D7E","Marble Blue","{\"rgb\" : [86, 109, 126]}");
        colorNameDB.insertNewColorData("737CA1","Slate Blue","{\"rgb\" : [115, 124, 161]}");
        colorNameDB.insertNewColorData("2B547E","Blue Jay","{\"rgb\" : [43, 84, 126]}");
        colorNameDB.insertNewColorData("2B3856","Dark Slate Blue","{\"rgb\" : [43, 56, 86]}");
        colorNameDB.insertNewColorData("15317E","Lapis Blue","{\"rgb\" : [21, 49, 126]}");
        colorNameDB.insertNewColorData("151B8D","Denim Dark Blue","{\"rgb\" : [21, 27, 141]}");
        colorNameDB.insertNewColorData("0000A0","Earth Blue","{\"rgb\" : [0, 0, 160]}");
        colorNameDB.insertNewColorData("0020C2","Cobalt Blue","{\"rgb\" : [0, 32, 194]}");
        colorNameDB.insertNewColorData("0041C2","Blueberry Blue","{\"rgb\" : [0, 65, 194]}");
        colorNameDB.insertNewColorData("2554C7","Sapphire Blue","{\"rgb\" : [37, 84, 199]}");
        colorNameDB.insertNewColorData("1569C7","Blue Eyes","{\"rgb\" : [21, 105, 199]}");
        colorNameDB.insertNewColorData("1F45FC","Blue Orchid","{\"rgb\" : [31, 69, 252]}");
        colorNameDB.insertNewColorData("6960EC","Blue Lotus","{\"rgb\" : [105, 96, 236]}");
        colorNameDB.insertNewColorData("736AFF","Light Slate Blue","{\"rgb\" : [115, 106, 255]}");
        colorNameDB.insertNewColorData("357EC7","Windows Blue","{\"rgb\" : [53, 126, 199]}");
        colorNameDB.insertNewColorData("368BC1","Glacial Blue Ice","{\"rgb\" : [54, 139, 193]}");
        colorNameDB.insertNewColorData("488AC7","Silk Blue","{\"rgb\" : [72, 138, 199]}");
        colorNameDB.insertNewColorData("3090C7","Blue Ivy","{\"rgb\" : [48, 144, 199]}");
        colorNameDB.insertNewColorData("659EC7","Blue Koi","{\"rgb\" : [101, 158, 199]}");
        colorNameDB.insertNewColorData("87AFC7","Columbia Blue","{\"rgb\" : [135, 175, 199]}");
        colorNameDB.insertNewColorData("728FCE","Light Steel Blue","{\"rgb\" : [114, 143, 206]}");
        colorNameDB.insertNewColorData("2B65EC","Ocean Blue","{\"rgb\" : [43, 101, 236]}");
        colorNameDB.insertNewColorData("157DEC","Blue Dress","{\"rgb\" : [21, 125, 236]}");
        colorNameDB.insertNewColorData("38ACEC","Butterfly Blue","{\"rgb\" : [56, 172, 236]}");
        colorNameDB.insertNewColorData("5CB3FF","Crystal Blue","{\"rgb\" : [92, 179, 255]}");
        colorNameDB.insertNewColorData("3BB9FF","Deep Sky Blue","{\"rgb\" : [59, 185, 255]}");
        colorNameDB.insertNewColorData("79BAEC","Denim Blue","{\"rgb\" : [121, 186, 236]}");
        colorNameDB.insertNewColorData("82CAFA","Light Sky Blue","{\"rgb\" : [130, 202, 250]}");
        colorNameDB.insertNewColorData("82CAFF","Day Sky Blue","{\"rgb\" : [130, 202, 255]}");
        colorNameDB.insertNewColorData("A0CFEC","Jeans Blue","{\"rgb\" : [160, 207, 236]}");
        colorNameDB.insertNewColorData("B7CEEC","Blue Angel","{\"rgb\" : [183, 206, 236]}");
        colorNameDB.insertNewColorData("B4CFEC","Pastel Blue","{\"rgb\" : [180, 207, 236]}");
        colorNameDB.insertNewColorData("C2DFFF","Sea Blue","{\"rgb\" : [194, 223, 255]}");
        colorNameDB.insertNewColorData("AFDCEC","Coral Blue","{\"rgb\" : [175, 220, 236]}");
        colorNameDB.insertNewColorData("ADDFFF","Light Blue","{\"rgb\" : [173, 223, 255]}");
        colorNameDB.insertNewColorData("BDEDFF","Robin Egg Blue","{\"rgb\" : [189, 237, 255]}");
        colorNameDB.insertNewColorData("CFECEC","Pale Blue Lily","{\"rgb\" : [207, 236, 236]}");
        colorNameDB.insertNewColorData("E0FFFF","Light Cyan","{\"rgb\" : [224, 255, 255]}");
        colorNameDB.insertNewColorData("EBF4FA","Water","{\"rgb\" : [235, 244, 250]}");
        colorNameDB.insertNewColorData("93FFE8","Light Aquamarine","{\"rgb\" : [147, 255, 232]}");
        colorNameDB.insertNewColorData("9AFEFF","Electric Blue","{\"rgb\" : [154, 254, 255]}");
        colorNameDB.insertNewColorData("7FFFD4","Aquamarine","{\"rgb\" : [127, 255, 212]}");
        colorNameDB.insertNewColorData("7DFDFE","Tron Blue","{\"rgb\" : [125, 253, 254]}");
        colorNameDB.insertNewColorData("57FEFF","Blue Zircon","{\"rgb\" : [87, 254, 255]}");
        colorNameDB.insertNewColorData("8EEBEC","Blue Lagoon","{\"rgb\" : [142, 235, 236]}");
        colorNameDB.insertNewColorData("81D8D0","Tiffany Blue","{\"rgb\" : [129, 216, 208]}");
        colorNameDB.insertNewColorData("92C7C7","Cyan Opaque","{\"rgb\" : [146, 199, 199]}");
        colorNameDB.insertNewColorData("77BFC7","Blue Hosta","{\"rgb\" : [119, 191, 199]}");
        colorNameDB.insertNewColorData("78C7C7","Northern Lights Blue","{\"rgb\" : [120, 199, 199]}");
        colorNameDB.insertNewColorData("48CCCD","Medium Turquoise","{\"rgb\" : [72, 204, 205]}");
        colorNameDB.insertNewColorData("46C7C7","Jelly Fish","{\"rgb\" : [70, 199, 199]}");
        colorNameDB.insertNewColorData("7BCCB5","Blue Green","{\"rgb\" : [123, 204, 181]}");
        colorNameDB.insertNewColorData("43BFC7","Macaw Blue Green","{\"rgb\" : [67, 191, 199]}");
        colorNameDB.insertNewColorData("3EA99F","Light Sea Green","{\"rgb\" : [62, 169, 159]}");
        colorNameDB.insertNewColorData("3B9C9C","Dark Turquoise","{\"rgb\" : [59, 156, 156]}");
        colorNameDB.insertNewColorData("438D80","Sea Turtle Green","{\"rgb\" : [67, 141, 128]}");
        colorNameDB.insertNewColorData("348781","Medium Aquamarine","{\"rgb\" : [52, 135, 129]}");
        colorNameDB.insertNewColorData("307D7E","Greenish Blue","{\"rgb\" : [48, 125, 126]}");
        colorNameDB.insertNewColorData("5E7D7E","Grayish Turquoise","{\"rgb\" : [94, 125, 126]}");
        colorNameDB.insertNewColorData("4C787E","Beetle Green","{\"rgb\" : [76, 120, 126]}");
        colorNameDB.insertNewColorData("617C58","Hazel Green","{\"rgb\" : [97, 124, 88]}");
        colorNameDB.insertNewColorData("728C00","Venom Green","{\"rgb\" : [114, 140, 0]}");
        colorNameDB.insertNewColorData("254117","Dark Forest Green","{\"rgb\" : [37, 65, 23]}");
        colorNameDB.insertNewColorData("306754","Medium Sea Green","{\"rgb\" : [48, 103, 84]}");
        colorNameDB.insertNewColorData("347235","Medium Forest Green","{\"rgb\" : [52, 114, 53]}");
        colorNameDB.insertNewColorData("437C17","Seaweed Green","{\"rgb\" : [67, 124, 23]}");
        colorNameDB.insertNewColorData("347C17","Shamrock Green","{\"rgb\" : [52, 124, 23]}");
        colorNameDB.insertNewColorData("348017","Medium Spring Green","{\"rgb\" : [52, 128, 23]}");
        colorNameDB.insertNewColorData("6AA121","Green Onion","{\"rgb\" : [106, 161, 33]}");
        colorNameDB.insertNewColorData("41A317","Lime Green","{\"rgb\" : [65, 163, 23]}");
        colorNameDB.insertNewColorData("3EA055","Clover Green","{\"rgb\" : [62, 160, 85]}");
        colorNameDB.insertNewColorData("6CBB3C","Green Snake","{\"rgb\" : [108, 187, 60]}");
        colorNameDB.insertNewColorData("6CC417","Alien Green","{\"rgb\" : [108, 196, 23]}");
        colorNameDB.insertNewColorData("4CC417","Green Apple","{\"rgb\" : [76, 196, 23]}");
        colorNameDB.insertNewColorData("54C571","Zombie Green","{\"rgb\" : [84, 197, 113]}");
        colorNameDB.insertNewColorData("99C68E","Frog Green","{\"rgb\" : [153, 198, 142]}");
        colorNameDB.insertNewColorData("85BB65","Dollar Bill Green","{\"rgb\" : [133, 187, 101]}");
        colorNameDB.insertNewColorData("8BB381","Dark Sea Green","{\"rgb\" : [139, 179, 129]}");
        colorNameDB.insertNewColorData("9CB071","Iguana Green","{\"rgb\" : [156, 176, 113]}");
        colorNameDB.insertNewColorData("B2C248","Avocado Green","{\"rgb\" : [178, 194, 72]}");
        colorNameDB.insertNewColorData("9DC209","Pistachio Green","{\"rgb\" : [157, 194, 9]}");
        colorNameDB.insertNewColorData("A1C935","Salad Green","{\"rgb\" : [161, 201, 53]}");
        colorNameDB.insertNewColorData("59E817","Nebula Green","{\"rgb\" : [89, 232, 23]}");
        colorNameDB.insertNewColorData("57E964","Spotlight Go Green","{\"rgb\" : [87, 233, 100]}");
        colorNameDB.insertNewColorData("5FFB17","Emerald Green","{\"rgb\" : [95, 251, 23]}");
        colorNameDB.insertNewColorData("87F717","Lawn Green","{\"rgb\" : [135, 247, 23]}");
        colorNameDB.insertNewColorData("6AFB92","Dragon Green","{\"rgb\" : [106, 251, 146]}");
        colorNameDB.insertNewColorData("B5EAAA","Green THumb","{\"rgb\" : [181, 234, 170]}");
        colorNameDB.insertNewColorData("C3FDB8","Light Jade","{\"rgb\" : [195, 253, 184]}");
        colorNameDB.insertNewColorData("BCE954","Slime Green","{\"rgb\" : [188, 233, 84]}");
        colorNameDB.insertNewColorData("FFE87C","Sun Yellow","{\"rgb\" : [255, 232, 124]}");
        colorNameDB.insertNewColorData("FFF380","Corn Yellow","{\"rgb\" : [255, 243, 128]}");
        colorNameDB.insertNewColorData("FFF8DC","CornSilk","{\"rgb\" : [255, 248, 220]}");
        colorNameDB.insertNewColorData("FBF6D9","Blonde","{\"rgb\" : [251, 246, 217]}");
        colorNameDB.insertNewColorData("FAEBD7","Antique White","{\"rgb\" : [250, 235, 215]}");
        colorNameDB.insertNewColorData("FFEBCD","Blanched Almond","{\"rgb\" : [255, 235, 205]}");
        colorNameDB.insertNewColorData("ECE5B6","Tan Brown","{\"rgb\" : [236, 229, 182]}");
        colorNameDB.insertNewColorData("FFD801","Rubber Ducky Yellow","{\"rgb\" : [255, 216, 1]}");
        colorNameDB.insertNewColorData("FDD017","Bright Gold","{\"rgb\" : [253, 208, 23]}");
        colorNameDB.insertNewColorData("EAC117","Golden Brown","{\"rgb\" : [234, 193, 23]}");
        colorNameDB.insertNewColorData("F2BB66","Macaroni and Cheese","{\"rgb\" : [242, 187, 102]}");
        colorNameDB.insertNewColorData("FBB117","Beer","{\"rgb\" : [251, 177, 23]}");
        colorNameDB.insertNewColorData("FFA62F","Cantaloupe","{\"rgb\" : [255, 166, 47]}");
        colorNameDB.insertNewColorData("E9AB17","Bee Yellow","{\"rgb\" : [233, 171, 23]}");
        colorNameDB.insertNewColorData("E2A76F","Brown Sugar","{\"rgb\" : [226, 167, 111]}");
        colorNameDB.insertNewColorData("DEB887","Burly Wood","{\"rgb\" : [222, 184, 135]}");
        colorNameDB.insertNewColorData("FFCBA4","Deep Peech","{\"rgb\" : [255, 203, 164]}");
        colorNameDB.insertNewColorData("C9BE62","Ginger Brown","{\"rgb\" : [201, 190, 98]}");
        colorNameDB.insertNewColorData("C8B560","Fall Leaf Brown","{\"rgb\" : [200, 181, 96]}");
        colorNameDB.insertNewColorData("D4A017","Orange Gold","{\"rgb\" : [212, 160, 23]}");
        colorNameDB.insertNewColorData("C2B280","Sand","{\"rgb\" : [194, 178, 128]}");
        colorNameDB.insertNewColorData("C7A317","Cookie Brown","{\"rgb\" : [199, 163, 23]}");
        colorNameDB.insertNewColorData("B5A642","Brass","{\"rgb\" : [181, 166, 66]}");
        colorNameDB.insertNewColorData("C19A6B","Camel Brown","{\"rgb\" : [193, 154, 107]}");
        colorNameDB.insertNewColorData("C88141","Tiger Orange","{\"rgb\" : [200, 129, 65]}");
        colorNameDB.insertNewColorData("AF9B60","Bullet Shell","{\"rgb\" : [175, 155, 96]}");
        colorNameDB.insertNewColorData("AF7817","Dark Goldenrod","{\"rgb\" : [175, 120, 23]}");
        colorNameDB.insertNewColorData("806517","Oak Brown","{\"rgb\" : [128, 101, 23]}");
        colorNameDB.insertNewColorData("827839","Moccasin","{\"rgb\" : [130, 120, 57]}");
        colorNameDB.insertNewColorData("827B60","Army Brown","{\"rgb\" : [130, 123, 96]}");
        colorNameDB.insertNewColorData("835C3B","Brown Bear","{\"rgb\" : [131, 92, 59]}");
        colorNameDB.insertNewColorData("7F5217","Red Dirt","{\"rgb\" : [127, 82, 23]}");
        colorNameDB.insertNewColorData("C47451","Orange Salmon","{\"rgb\" : [196, 116, 81]}");
        colorNameDB.insertNewColorData("C35817","Red Fox","{\"rgb\" : [195, 88, 23]}");
        ...
        colorNameDB.insertNewColorData("F88017","Dark Orange","{\"rgb\" : [248, 128, 23]}");
        colorNameDB.insertNewColorData("F88158","Basket Ball Orange","{\"rgb\" : [248, 129, 88]}");
        colorNameDB.insertNewColorData("F9966B","Light Salmon","{\"rgb\" : [249, 150, 107]}");
